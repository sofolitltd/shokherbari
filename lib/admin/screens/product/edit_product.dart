...
class _EditProductState extends State<EditProduct> {
  ...
  void initState() {
    ...
    widget.product.featured == true ? _isSelected = 0 : _isSelected = 1;
                      ...
                      ElevatedButton(
                          onPressed: () {
                            if (_globalKey.currentState!.validate()) {
                              uploadToFirestore(widget.product.images);
  ...
  uploadToFirestore(imageList) async {
    ...
    //editProduct
    await ProductProviderAdmin.editProduct(product: product, uid: uid)
        .then((value) {
