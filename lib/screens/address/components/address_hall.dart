...
class AddressHall extends StatefulWidget {
  const AddressHall({Key? key, this.address}) : super(key: key);
...
class _AddressHallState extends State<AddressHall> {
  ...
  void initState() {
    if (widget.address != null) {
      ...
      _selectedHall = widget.address!.place;
      _roomController.text = widget.address!.address;
    }
              ...
              child: ListView(
                ...
                children: [
                  ...
                  DropdownButtonFormField(
                    ...
                    decoration: _selectedHall!.isNotEmpty
                        ? const InputDecoration(label: Text('Hall'))
                        : null,
                    value: _selectedHall!.isNotEmpty ? _selectedHall : null,
                    items: _hallList
                        ...
                        onPressed: () async {
                          if (_globalKey.currentState!.validate()) {
                            ...
                            await AddressProvider.addAddress(
                                UserRepo.refAddressHall, _address.toJson());
